from mistralai import Mistral   # FIXED: old `from mistralai.client import Mistral` is a pre-1.0 import
                                  # path that now raises NotImplementedError under mistralai>=1.0.
import os

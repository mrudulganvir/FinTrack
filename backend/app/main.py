from backend.app.services.categorization_service import _MODEL_PATH
...
from backend.app.routes import accounts_routes, advisor_routes, alert_routes, auth_route, budget_routes, chat_routes, forget_password_routes, investment_routes, loan_routes, onboarding_routes, predictive_budget_routes, report_routes, zerodha_routes
run_migrations()
...
app.include_router(zerodha_routes.router)
